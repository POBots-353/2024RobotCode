...
public class AutoClimbCenter extends SequentialCommandGroup {
  /** Creates a new AutoClimbCenter. */

  Swerve swerve;
  Climber climber;
  
  public AutoClimbCenter() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());

    double[] coordinates = swerve.getCenterChainPose();
