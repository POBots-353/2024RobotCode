...
public class LimelightHelpers {
  ...
  public static class PoseEstimate3d {
    public Pose3d pose;
    public double timestampSeconds;
    public double latency;
    public int tagCount;
  ...
  private static PoseEstimate3d getBotPoseEstimate3d(String limelightName, String entryName) {
    var poseEntry = LimelightHelpers.getLimelightNTTableEntry(limelightName, entryName);
    var poseArray = poseEntry.getDoubleArray(new double[0]);
   ...
   * @return
   */
  public static PoseEstimate3d getBotPoseEstimate3d_wpiBlue(String limelightName) {
    return getBotPoseEstimate3d(limelightName, "botpose_wpiblue");
  }
  ...
  /**
   * Gets the Pose3d and timestamp for use with WPILib pose estimator (addVisionMeasurement) when
   * you are on the BLUE alliance
   *
   * @param limelightName
   * @return
   */
  public static PoseEstimate3d getBotPoseEstimate3d_wpiBlue_MegaTag2(String limelightName) {
    return getBotPoseEstimate3d(limelightName, "botpose_orb_wpiblue");
  }
